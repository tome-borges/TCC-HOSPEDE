...
public class EditarQuarto extends InterfaceFactory {
    ...
    //Construtor.
    public EditarQuarto( JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
    ...
    public static EditarQuarto getInstance( JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        if(instance == null){
