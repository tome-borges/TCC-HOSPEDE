...
public class CadastrarReserva extends InterfaceFactory {
    ...
    public CadastrarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        setTitle("Reservar");
    ...
    public void receberReserva(Reserva reserva){
    ...
    public void receberliente(Cliente cliente){
    ...
    public static CadastrarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        if (instance == null) {
            instance = new CadastrarReserva(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
        }
        return instance;
    }
}
