...
public class PasseioDAO {
    ...
    public ArrayList<AdicionarClientePasseio> listarPasseiosFecharConta(Reserva reserva){
        AdicionarClientePasseio passeio;
        ArrayList<AdicionarClientePasseio> listaPasseio = new ArrayList<AdicionarClientePasseio>();
        banco = ConectarBanco.getInstance();
        banco.conectar();
        try{
            ...
            while(resultSet.next()){
                passeio = new AdicionarClientePasseio();
                passeio.setTituloPasseio(resultSet.getString(1));
                passeio.setNome(resultSet.getString(4));
                passeio.setCpf(resultSet.getString(5));
                passeio.setQuarto(resultSet.getString(6));
                passeio.setResponsavel(resultSet.getString(8));
