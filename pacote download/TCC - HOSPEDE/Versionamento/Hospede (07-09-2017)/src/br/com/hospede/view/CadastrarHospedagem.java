...
public class CadastrarHospedagem extends InterfaceFactory{
    ...
    public CadastrarHospedagem(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        setTitle("Hospedar");
    ...
    public void receberHospedagem(Reserva reserva){
    ...
    public Reserva getReservaParaHospedar(){
        Reserva reserva = new Reserva();
    ...
    public static CadastrarHospedagem getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        if (instance == null) {
