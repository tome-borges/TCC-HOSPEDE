...
public class AuditarPasseio extends InterfaceFactory{
    ...
    public AuditarPasseio(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado,Object[] modelosTabelas){
    ...
    public static AuditarPasseio getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado,Object[] modelosTabelas){
        if(instance == null){
            instance = new AuditarPasseio(botoes, itensDeMenu, camposDeTexto, usuarioLogado,modelosTabelas);
        }
