...
import static br.com.hospede.control.ControlarEventos.QUANTIDADE_MODELOS;
...
public class CadastrarCliente extends InterfaceFactory {
    ...
    public static CadastrarCliente instance = null;
    ...
    public CadastrarCliente(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        ...
        txtPassaporte.setLocation(130, 73);
        ...
        btnCadastrar.setLocation(110, 500);
        ...
        botoes[9] = btnCadastrar;
        camposDeTexto[7] = txtCPF;
        camposDeTexto[21] = txtPassaporte;
    ...
    public void itemStateChanged(ItemEvent evento) {
        if (rdbCPF.isSelected()) {
            ...
            try {
                ...
                txtPassaporte.setEditable(false);
                txtPassaporte.addFocusListener(null);
            ...
            try {
                ...
                txtCPF.setEditable(false);
                txtCPF.addFocusListener(null);
                painel.remove(txtCPF);
                txtCPF.setText("");
                txtPassaporte.setText("TESTE");
                txtPassaporte.setText("");
                painel.add(txtPassaporte);
                txtPassaporte.addFocusListener(eventos);
                txtPassaporte.setEditable(true);
                
                CadastrarCliente cadastrarCliente =  CadastrarCliente.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
    ...
    public static CadastrarCliente getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        if (instance == null) {
            return instance = new CadastrarCliente(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
