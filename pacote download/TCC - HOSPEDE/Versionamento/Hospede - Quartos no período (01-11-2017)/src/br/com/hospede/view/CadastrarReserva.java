...
public class CadastrarReserva extends InterfaceFactory {

    public static CadastrarReserva instance;
    ...
    public CadastrarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        setTitle("Reservar");
        ...
        botoes[19] = btnReservar;
        camposDeTexto[7] = txtCPF;
    ...
    public static CadastrarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        if (instance == null) {
            instance = new CadastrarReserva(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
