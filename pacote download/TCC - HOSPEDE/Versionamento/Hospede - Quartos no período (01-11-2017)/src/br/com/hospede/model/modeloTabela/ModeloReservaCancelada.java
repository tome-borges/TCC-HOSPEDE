...
public class ModeloReservaCancelada extends AbstractTableModel{

   private ArrayList<DTOReceitaDiaria>  dados;
    private String[]            colunas = {"Hospedagem","Quarto","Cliente","Entrada","Saída","Status"};
    private SimpleDateFormat   formatarData = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
    public static ModeloReservaCancelada instance;

    public ModeloReservaCancelada() {
        dados = new ArrayList<>();
    }
    ...
    public static ModeloReservaCancelada getInstance() {
        if (instance == null) {
            return instance = new ModeloReservaCancelada();
        }
        return instance;
    }
