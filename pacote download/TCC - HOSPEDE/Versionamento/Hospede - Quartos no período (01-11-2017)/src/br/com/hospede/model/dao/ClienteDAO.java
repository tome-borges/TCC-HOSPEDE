...
public class ClienteDAO {
    ...
    public boolean editarCliente(DTOCliente cliente){
        ...
        try{
            statement = banco.setStatement("UPDATE cliente SET nome = ?, rg = ?, endereco = ?, bairro = ?,"
                    ...
                    + "cep = ?, passaporte = ?, estado = ? WHERE id = ?");
            ...
            statement.setInt(13, cliente.getId_cliente());
    ...
    //---------------------------------------------------------------------------------------------------------------------------
     public boolean deletarClientePassaporte(String passaporte){
        banco = ConectarBanco.getInstance();
        banco.conectar();
        boolean deletou = false;
        try{
            statement = banco.setStatement("DELETE FROM cliente WHERE passaporte = ?");
            statement.setString(1, passaporte);
