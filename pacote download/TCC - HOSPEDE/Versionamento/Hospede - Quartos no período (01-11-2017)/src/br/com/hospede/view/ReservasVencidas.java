...
public class ReservasVencidas extends InterfaceFactory{
    public static ReservasVencidas instance;
    private modeloReservasVencidas modeloReceita;
    ...
    public ReservasVencidas(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        setTitle("Reservas Vencidas");
        ...
        //Tabela.
        modeloReceita = modeloReservasVencidas.getInstance();
    ...
    public static ReservasVencidas getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        if (instance == null) {
            return instance = new ReservasVencidas(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
