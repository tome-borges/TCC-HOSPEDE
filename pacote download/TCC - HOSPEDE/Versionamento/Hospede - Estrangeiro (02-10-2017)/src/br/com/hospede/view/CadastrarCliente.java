...
public class CadastrarCliente extends InterfaceFactory {
    ...
    public CadastrarCliente(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado) {
    ...
    public void itemStateChanged(ItemEvent evento) {
        if (rdbCPF.isSelected()) {
            ...
            try {
                ...
                CadastrarCliente cadastrarCliente =  CadastrarCliente.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
    ...
    public static CadastrarCliente getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado) {
        if (instance == null) {
            return instance = new CadastrarCliente(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
        }
        return instance;
    }
}
