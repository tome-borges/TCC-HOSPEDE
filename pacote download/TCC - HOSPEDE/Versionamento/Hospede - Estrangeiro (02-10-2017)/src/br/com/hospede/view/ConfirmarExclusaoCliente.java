...
public class ConfirmarExclusaoCliente extends InterfaceFactory{
    ...
    public ConfirmarExclusaoCliente(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static ConfirmarExclusaoCliente getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
            instance = new ConfirmarExclusaoCliente(botoes,itensDeMenu, campoDeTexto, usuarioLogado);
        }
        return instance;
    }
}
