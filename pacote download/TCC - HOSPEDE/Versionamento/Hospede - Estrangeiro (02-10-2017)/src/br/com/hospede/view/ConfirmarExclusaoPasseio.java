...
public class ConfirmarExclusaoPasseio extends InterfaceFactory{
    ...
    public ConfirmarExclusaoPasseio(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static ConfirmarExclusaoPasseio getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
            instance = new ConfirmarExclusaoPasseio(botoes,itensDeMenu, campoDeTexto, usuarioLogado);
        }
        return instance;
    }
}
