...
public class AuditarReserva extends InterfaceFactory{
    ...
    public AuditarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static AuditarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
            instance = new AuditarReserva(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
        }
