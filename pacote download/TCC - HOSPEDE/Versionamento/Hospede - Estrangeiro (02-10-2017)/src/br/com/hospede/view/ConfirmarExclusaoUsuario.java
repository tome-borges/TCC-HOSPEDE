...
public class ConfirmarExclusaoUsuario extends InterfaceFactory{
    ...
    public ConfirmarExclusaoUsuario(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static ConfirmarExclusaoUsuario getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
            instance = new ConfirmarExclusaoUsuario(botoes,itensDeMenu, campoDeTexto, usuarioLogado);
        }
        return instance;
    }
}
