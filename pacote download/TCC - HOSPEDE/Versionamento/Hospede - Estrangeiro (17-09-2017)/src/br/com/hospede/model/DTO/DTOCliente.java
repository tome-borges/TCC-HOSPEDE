...
public class DTOCliente {
    ...
    private String nome, cidade, estado, endereco, bairro, complemento, email, passaporte,
                   cpf, rg, cep, telefone, celular;
    private ImageIcon editar, deletar;

    public DTOCliente(int id_cliente, int cadastrado_por, String nome, String cidade, String estado, String endereco, String bairro, String complemento, String email, String cpf, String rg, String cep, String telefone, String celular) {
    ...
    public void setPassaport(String passaporte) {
