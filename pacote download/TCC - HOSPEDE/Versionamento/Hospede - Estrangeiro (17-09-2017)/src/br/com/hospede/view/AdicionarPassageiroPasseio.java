...
public class AdicionarPassageiroPasseio extends InterfaceFactory {
    ...
    private JTextField txtTitulo, txtIngresso, txtCpfCliente, txtQuarto, txtCelular, txtNomePassageiro,
    ...
    private JFormattedTextField txtcfpCliente, txtCpfPassageiro;
