...
public class ModeloPedidosDeQuarto extends AbstractTableModel{
    private ArrayList<DTOProduto>  dados;
    private String[]                   colunas = {"Nome", "Quantidade Pedida", "preço"};
    public static ModeloPedidosDeQuarto instance = null;
    private SimpleDateFormat           formatarData = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
    
    public ModeloPedidosDeQuarto(){
        dados = new ArrayList<>();
    }
    
    public ArrayList<DTOProduto> getProdutos(){
        return dados;
    }
    ...
    public void adicionar(DTOProduto produto){
     ...
     public ArrayList<DTOProduto> getPedidosDeQuarto(){
        return dados;
    }
    ...
    public static ModeloPedidosDeQuarto getInstance(){
        if(instance == null){
            instance = new ModeloPedidosDeQuarto();
        }
        return instance;
    }
}
