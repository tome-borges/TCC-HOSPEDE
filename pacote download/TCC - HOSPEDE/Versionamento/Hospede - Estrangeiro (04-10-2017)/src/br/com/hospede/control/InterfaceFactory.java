...
public class InterfaceFactory extends JFrame implements ItemListener{
    ...
    public static InterfaceFactory getInterface(int codigoInterface, JButton botoes[], JMenuItem itensDeMenu[],
                                                 JTextField camposDeTexto[], DTOUsuario usuarioLogado) { 
        ...
        switch (codigoInterface) {
           ...
           case 46:
               ...
               return AuditarProduto.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 47:
                //Retorna uma instância da classe "AuditarPasseio".
               return AuditarPasseio.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 48:
                //Retorna uma instância da classe "SelecionarCliente".
               return SelecionarCliente.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 49:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoUsuario.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 50:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoQuarto.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 51:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoCliente.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 52:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoReserva.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 53:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoProduto.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
           case 54:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoPasseio.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
            default:
                break;
        }
        return null;
