...
public class CadastrarPasseios extends InterfaceFactory{
    ...
    public CadastrarPasseios(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static CadastrarPasseios getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
