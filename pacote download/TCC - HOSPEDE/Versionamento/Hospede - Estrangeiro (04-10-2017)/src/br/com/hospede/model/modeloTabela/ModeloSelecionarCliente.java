...
public class ModeloSelecionarCliente extends AbstractTableModel{
    private ArrayList<DTOCliente>  dados;
    private String[]            colunas = {"Nome", "CPF", "RG", "Estado", "Cidade", "Endereço", "Bairro", "CEP",
                                           "Telefone", "Celular", "Email"};
    public static ModeloSelecionarCliente instance;

    public ModeloSelecionarCliente() {
        dados = new ArrayList<>();
    }
    ...
    public static ModeloSelecionarCliente getInstance() {
        if (instance == null) {
            return instance = new ModeloSelecionarCliente();
        }
        return instance;
    }
}
