...
public class ConfirmarExclusaoProduto extends InterfaceFactory{
    ...
    public ConfirmarExclusaoProduto(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static ConfirmarExclusaoProduto getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
            instance = new ConfirmarExclusaoProduto(botoes,itensDeMenu, campoDeTexto, usuarioLogado);
        }
        return instance;
    }
}
