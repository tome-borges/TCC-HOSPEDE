...
public class ConfirmarExclusaoQuarto extends InterfaceFactory{
    ...
    public ConfirmarExclusaoQuarto(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
    ...
    public static ConfirmarExclusaoQuarto getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado){
        if(instance == null){
            instance = new ConfirmarExclusaoQuarto(botoes,itensDeMenu, campoDeTexto, usuarioLogado);
        }
        return instance;
    }
}
