...
public class ConsultarUsuario extends InterfaceFactory{
    ...
    private InterfaceFactory interfaceConfirmarExclusao;
        ...
        tabela.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(coluna == 5){
                    ...
                    interfaceConfirmarExclusao = ConfirmarExclusaoUsuario.getInterface(49, botoes, itensDeMenu, camposDeTexto, usuarioLogado);
