...
public class HistoricoDAO {
    ...
    public void salvarManterPasseio(DTOHistoricoPasseio historicoPasseio) {
        ...
        try {
            statement = banco.setStatement("INSERT INTO historico_passeio (id_passeio, id_cliente,id_usuario_responsavel_por_registrar, data_registro, acao, passeio ) VALUES  (?,?,?,?,?,?)");
    ...
    public void salvarManterProduto(DTOHistoricoProduto historicoProduto) {
        ...
        try {
            statement = banco.setStatement("INSERT INTO historico_produto (id_produto,id_usuario_responsavel, data_acao, acao, produto ) VALUES  (?,?,?,?,?)");
    ...
    public ArrayList<DTOHistoricoPasseio> auditarPasseio() {
        ...
        try {
            statement = banco.setStatement("SELECT\n"
                    ...
                    + "INNER JOIN usuario T3 ON T1.id_usuario_responsavel_por_Registrar = T3.id\n"
                    + "ORDER BY T1.data_registro");
            ...
            while (resultSet.next()) {
                ...
                HistoricoPasseio.setPasseio(resultSet.getString(5));
    ...
    public ArrayList<DTOHistoricoProduto> auditarProduto() {
        ...
        try {
            statement = banco.setStatement("SELECT\n"
                    ...
                    + "INNER JOIN produto T2 ON T1.id_produto = T2.id\n"
                    + "INNER JOIN usuario T3 ON T1.id_usuario_responsavel = T3.id\n"
            ...
            while (resultSet.next()) {
                ...
                historicoProduto.setProduto(resultSet.getString(5));
