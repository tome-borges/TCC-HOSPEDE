...
public class AuditarCliente extends InterfaceFactory{
    ...
    public AuditarCliente(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
    ...
    public static AuditarCliente getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            instance = new AuditarCliente(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
