...
public class CadastrarUsuario extends InterfaceFactory {
    ...
    //Construtor..
    public CadastrarUsuario(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
    ...
    public static CadastrarUsuario getInstance( JButton botoes[],JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas
) {
        if (instance == null) {
            return instance = new CadastrarUsuario( botoes, itensDeMenu, campoDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
