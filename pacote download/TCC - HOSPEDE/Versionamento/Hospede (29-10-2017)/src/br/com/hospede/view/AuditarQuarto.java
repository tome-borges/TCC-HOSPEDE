...
public class AuditarQuarto extends InterfaceFactory{
    ...
    public AuditarQuarto(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
    ...
    public static AuditarQuarto getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado,Object[] modelosTabelas){
        if(instance == null){
            instance = new AuditarQuarto(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
