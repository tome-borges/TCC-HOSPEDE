...
public class HistoricoDAO {
    ...
    public void salvarManterPasseio(DTOHistoricoPasseio historicoPasseio) {
        ...
        try {
            statement = banco.setStatement("INSERT INTO historico_passeio (id_passeio,id_usuario_responsavel_por_registrar, dt_acao, acao, passeio ) VALUES  (?,?,?,?,?)");

            statement.setInt(1, historicoPasseio.getId_passeio());
            statement.setInt(2, historicoPasseio.getId_usuario_responsavel());
            statement.setTimestamp(3, dt_acaoSQL = new java.sql.Timestamp(new Date().getTime()));
            statement.setString(4, historicoPasseio.getAcao());
            statement.setString(5, historicoPasseio.getPasseio());
