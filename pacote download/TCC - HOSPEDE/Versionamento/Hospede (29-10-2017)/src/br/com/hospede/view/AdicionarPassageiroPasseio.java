...
public class AdicionarPassageiroPasseio extends InterfaceFactory {
    ...
    public AdicionarPassageiroPasseio(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
    ...
    public void itemStateChanged(ItemEvent evento) {
        if (rdbCPF.isSelected()) {
            ...
            try {
                ...
                AdicionarPassageiroPasseio tela = AdicionarPassageiroPasseio.getInstance(botoes, itensDeMenu, campoDeTexto, usuarioLogado, modeloTabelas);
    ...
    public static AdicionarPassageiroPasseio getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        if (instance == null) {
            instance = new AdicionarPassageiroPasseio(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
