    ...
    public static InterfaceFactory getInterface(int codigoInterface, JButton botoes[], JMenuItem itensDeMenu[],
        ...
        switch (codigoInterface) {
           ...
           case 49:
               ...
               return ConfirmarExclusaoUsuario.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
           case 50:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoQuarto.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
           case 51:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoCliente.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
           case 52:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoReserva.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
           case 53:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoProduto.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
           case 54:
                //Retorna uma instância da classe "ConfirmarExclusão".
               return ConfirmarExclusaoPasseio.getInstance(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modeloTabelas);
            default:
                break;
        }
        return null;
