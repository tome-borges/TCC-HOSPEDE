...
public class ConfirmarExclusaoQuarto extends InterfaceFactory{
    private JButton btnCancelar, btnConfirmar;
    private JLabel lblAviso;
    public static ConfirmarExclusaoQuarto instance;
    ...
    public ConfirmarExclusaoQuarto(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        ...
        lblAviso = new JLabel("Tem certeza que deseja deletar o quarto?");
        ...
        botoes[81] = btnConfirmar;
        botoes[80] = btnCancelar;
    ...
    public static ConfirmarExclusaoQuarto getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            instance = new ConfirmarExclusaoQuarto(botoes,itensDeMenu, campoDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
