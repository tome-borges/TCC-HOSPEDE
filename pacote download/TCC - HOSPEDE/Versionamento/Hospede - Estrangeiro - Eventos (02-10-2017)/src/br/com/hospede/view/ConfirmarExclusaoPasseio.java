...
public class ConfirmarExclusaoPasseio extends InterfaceFactory{
    private JButton btnCancelar, btnConfirmar;
    private JLabel lblAviso;
    public static ConfirmarExclusaoPasseio instance;
    ...
    public ConfirmarExclusaoPasseio(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        ...
        lblAviso = new JLabel("Tem certeza que deseja deletar o passeio?");
        ...
        botoes[88] = btnConfirmar;
        botoes[89] = btnCancelar;
    ...
    public static ConfirmarExclusaoPasseio getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            instance = new ConfirmarExclusaoPasseio(botoes,itensDeMenu, campoDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
