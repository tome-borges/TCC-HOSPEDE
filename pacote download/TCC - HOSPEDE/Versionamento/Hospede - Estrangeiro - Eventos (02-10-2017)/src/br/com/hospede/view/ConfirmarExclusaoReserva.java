...
public class ConfirmarExclusaoReserva extends InterfaceFactory{
    ...
    public ConfirmarExclusaoReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
    ...
    public static ConfirmarExclusaoReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            instance = new ConfirmarExclusaoReserva(botoes,itensDeMenu, campoDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
