...
public class ConfirmarExclusaoUsuario extends InterfaceFactory{
    
    private JButton btnCancelar, btnConfirmar;
    private JLabel lblAviso;
    public static ConfirmarExclusaoUsuario instance;
    ...
    public ConfirmarExclusaoUsuario(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado,Object[] modelosTabelas
){
        ...
        lblAviso = new JLabel("Tem certeza que deseja deletar o usuário?");
        ...
        botoes[49] = btnConfirmar;
        botoes[52] = btnCancelar;
    ...
    public static ConfirmarExclusaoUsuario getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas
){
        if(instance == null){
            instance = new ConfirmarExclusaoUsuario(botoes,itensDeMenu, campoDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
