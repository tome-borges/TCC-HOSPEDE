...
public class DTOQuarto {
    ...
    private String    situacao,ocupantes, categoria, numero, nome_cliente;
    private Double    diaria;
    private ImageIcon iconeDeSituacao;
    private Date    entrada, saida;
    private ImageIcon editar, deletar;

    public DTOQuarto(int id_quarto, String situacao, String ocupantes, String categoria, Double diaria, String numero, String nome_cliente, ImageIcon iconeDeSituacao, Date entrada) {
