...
public class ReservaDAO {
    ...
    private QuartoDAO quartoDAO = QuartoDAO.getInstance();
    ...
    public DTOReserva pesquisarReserva(DTOCliente cliente) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                reserva.setId_quarto(resultSet.getInt(10));
            }
    ...
    //-----------------------------------------------------------------------------------------------------------------------------------------------------------
    public boolean editarHospedagemFechamento(DTOReserva reserva) {
        banco = ConectarBanco.getInstance();
        banco.conectar();
        boolean editou = false;
        try {
            statement = banco.setStatement("UPDATE reserva SET"
                    + " entrada=?, saida=?, status = ?, saldo = ?, dt_fechamento = ? WHERE id = ? AND tipo = 'HOSPEDAR'");

            statement.setTimestamp(1, data_entradaSQL = new Timestamp(reserva.getEntrada().getTime()));
            statement.setTimestamp(2, data_saidaSQL = new Timestamp(reserva.getSaida().getTime()));
            statement.setString(3, reserva.getStatus());
            statement.setDouble(4, reserva.getSaldo());
            statement.setTimestamp(5, data_entrada_hospedagemSQL = new java.sql.Timestamp(new java.util.Date().getTime()));
    ...
    public DTOReserva pesquisarHospedagem(DTOCliente cliente) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                reserva.setId_quarto(resultSet.getInt(11));
            }
    ...
    public ArrayList<DTOReceitaDiaria> getReceitaDiaria() {
        ArrayList<DTOReceitaDiaria> reservas = new ArrayList<>();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                reserva.setDt_fechamento(resultSet.getTimestamp(8));
    ...
    //------------------------------------------------------------------------------------------------------------------
    public ArrayList<DTOReceitaDiaria> getReservasCanceladas() {
        ...
        try {
            statement = banco.setStatement("SELECT \n"
                    ...
                    + "INNER JOIN cliente T2 ON T1.ID_CLIENTE = T2.ID\n"
                    + "INNER JOIN quarto T3  ON T1.ID_QUARTO = T3.ID\n"
                    + "WHERE T1.STATUS ='CANCELADA' AND TIPO ='RESERVAR' ORDER BY T1.ENTRADA");
            resultSet = statement.executeQuery();
    ...
    //------------------------------------------------------------------------------------------------------------------
    public ArrayList<DTOReceitaDiaria> getReservasVencidas() {
        ArrayList<DTOReceitaDiaria> reservas = new ArrayList<DTOReceitaDiaria>();
...
"                    INNER JOIN cliente T2 ON T1.ID_CLIENTE = T2.ID\n" +
"                    INNER JOIN quarto T3  ON T1.ID_QUARTO = T3.ID\n" +
"                    WHERE T1.STATUS ='ABERTA' AND TIPO ='RESERVAR' AND to_char(T1.ENTRADA,'YYYY-MM-DD')< '"+formatarData.format(dataAtual)+"'\n" +
"                    ORDER BY T1.ENTRADA");
            resultSet = statement.executeQuery();
    ...
    //------------------------------------------------------------------------------------------------------------------
    public ArrayList<DTOReceitaDiaria> pesquisarReceitaDiaria(Date data) {
        ArrayList<DTOReceitaDiaria> reservas = new ArrayList<DTOReceitaDiaria>();
...
"                    INNER JOIN cliente T2 ON T1.ID_CLIENTE = T2.ID\n" +
"                    INNER JOIN quarto T3  ON T1.ID_QUARTO = T3.ID\n" +
"                    WHERE T1.STATUS IN ('ABERTA','FECHADA') AND TIPO ='HOSPEDAR' "
                    + "AND to_char(dt_fechamento,'YYYY-MM-dd')='"+formatarData.format(data)+"'\n" +
"                    ORDER BY T1.ENTRADA");
            resultSet = statement.executeQuery();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao listar receita diária:\n" + erro.getMessage());
        }
    ...
    //-----------------------------------------------------------------------------------------------------------------
    public ArrayList<DTOReceitaDiaria> pesquisarReceitaCancelada(Date data) {
        ArrayList<DTOReceitaDiaria> reservas = new ArrayList<DTOReceitaDiaria>();
...
"                    INNER JOIN cliente T2 ON T1.ID_CLIENTE = T2.ID\n" +
"                    INNER JOIN quarto T3  ON T1.ID_QUARTO = T3.ID\n" +
"                    WHERE T1.STATUS ='CANCELADA' AND TIPO ='RESERVAR' "
                    + "AND to_char(ENTRADA,'YYYY-MM-dd')='"+formatarData.format(data)+"'\n" +
"                    ORDER BY T1.ENTRADA");
            resultSet = statement.executeQuery();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao listar reservas canceladas:\n" + erro.getMessage());
        }
    ...
    //------------------------------------------------------------------------------------------------------------------
    public ArrayList<DTOReceitaDiaria> pesquisarReceitaVencidas(Date data) {
        ArrayList<DTOReceitaDiaria> reservas = new ArrayList<DTOReceitaDiaria>();
...
"                    INNER JOIN cliente T2 ON T1.ID_CLIENTE = T2.ID\n" +
"                    INNER JOIN quarto T3  ON T1.ID_QUARTO = T3.ID\n" +
"                    WHERE T1.STATUS = 'ABERTA' AND TIPO ='RESERVAR' "
                    + "AND to_char(T1.entrada,'YYYY-MM-dd')='"+formatarData.format(data)+"'\n" +
"                    ORDER BY T1.ENTRADA");
            resultSet = statement.executeQuery();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao listar reservas vencidas:\n" + erro.getMessage());
        }
