...
public class Login extends JFrame{
    ...
    public static Object[]   modeloTabelas = new Object[ControlarEventos.QUANTIDADE_MODELOS];
    private ControlarEventos eventos;
    public static  Login     instance = null;
    public static DTOUsuario usuarioLogado;
    ...
    public Login() {
        ...
        eventos = ControlarEventos.getInstance(botoes, itensDeMenu, camposDeTexto, usuario, modeloTabelas);
    ...
    public DTOUsuario getUsuario(){
        usuario = new DTOUsuario(0, 0,"admin", "admin","", "", "");
