...
public class AuditarProduto extends InterfaceFactory{
    ...
    public AuditarProduto(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado,Object[] modelosTabelas){
    ...
    public static AuditarProduto getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado,Object[] modelosTabelas){
        if(instance == null){
            instance = new AuditarProduto(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
