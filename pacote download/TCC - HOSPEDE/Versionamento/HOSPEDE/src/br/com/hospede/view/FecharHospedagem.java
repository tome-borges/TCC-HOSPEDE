...
public class FecharHospedagem extends InterfaceFactory {
    ...
    private JTextField txtNome, txtQuarto, txtDiasHospedados, txtTotalPagar,
    ...
    public FecharHospedagem(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
    ...
    public DTOReserva getHospedagem() {
        ...
        reserva.setSaldo(Double.parseDouble(txtTotalPagar.getText()));
        return reserva;
    }
    ...
    public String getTxtDiaria() {
        return txtDiaria.getText();
    }

    public String getTxtDiasHospedados() {
        return txtDiasHospedados.getText();
    }

    public String getTxtTotalPagar() {
        return txtTotalPagar.getText();
    }
    ...
    public String getTxtTotalHospedagem() {
        return txtTotalHospedagem.getText();
    }
    ...
    public String getTxtQuarto() {
        return txtQuarto.getText();
    }
    ...
    public static FecharHospedagem getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas) {
        if (instance == null) {
            return instance = new FecharHospedagem(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
