...
public class TelaPrincipal extends InterfaceFactory{
    ...
    private final JMenuItem              manualUsuario, relatorioReceita, relatorioReservasCanceladas, relatorioReservasVencidas;
    ...
    public TelaPrincipal(DTOUsuario usuarioLogado){
        ...
        manualUsuario = new JMenuItem("Manual do Usuário");
        relatorioReceita = new JMenuItem("Receita diária");
