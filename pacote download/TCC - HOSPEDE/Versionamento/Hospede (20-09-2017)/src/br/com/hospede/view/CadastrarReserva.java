...
public class CadastrarReserva extends InterfaceFactory {
    ...
    public CadastrarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado) {
        setTitle("Reservar");
    ...
    public static CadastrarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado) {
        if (instance == null) {
