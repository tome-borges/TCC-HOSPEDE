...
public class HistoricoDAO {
    ...
    public void salvarManterPasseio(DTOHistoricoPasseio historicoPasseio) {
        ...
        try {
            statement = banco.setStatement("INSERT INTO historico_passeio (id_passeio, id_cliente,id_usuario_responsavel_por_registrar, data_registro, acao ) VALUES  (?,?,?,?,?)");
    ...
    public void salvarManterProduto(DTOHistoricoProduto historicoProduto) {
        ...
        try {
            statement = banco.setStatement("INSERT INTO historico_produto (id_produto,id_usuario_responsavel, data_acao, acao ) VALUES  (?,?,?,?)");
