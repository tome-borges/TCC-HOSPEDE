...
public class ProdutoPedido extends InterfaceFactory{
    ...
    public ProdutoPedido(JButton botoes[],JMenuItem itensDeMenu[], JTextField[] camposDeTexto, DTOUsuario usuarioLogado){
    ...
    public static ProdutoPedido getInstance(JButton botoe[],JMenuItem itensDeMenu[],  JTextField[] camposDeTexto, DTOUsuario usuarioLogado){
        if(instance == null){
