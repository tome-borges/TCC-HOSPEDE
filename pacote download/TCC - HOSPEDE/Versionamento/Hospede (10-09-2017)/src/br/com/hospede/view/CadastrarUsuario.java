...
public class CadastrarUsuario extends InterfaceFactory {
    ...
    //Construtor..
    public CadastrarUsuario(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado) {
    ...
    public static CadastrarUsuario getInstance( JButton botoes[],JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado) {
        if (instance == null) {
