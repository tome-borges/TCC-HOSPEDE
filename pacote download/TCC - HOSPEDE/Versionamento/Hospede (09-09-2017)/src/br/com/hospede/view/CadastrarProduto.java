...
public class CadastrarProduto extends InterfaceFactory{
    ...
    public CadastrarProduto(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
    ...
    public static CadastrarProduto getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        if(instance == null){
