...
public class ConsultarQuarto extends InterfaceFactory{
    ...
    private JLabel                lblLivre, lblReservado, lblHospedado, lblManutencao, livre, hospedado, reservado, manutencao, lblOrganizando, organizando;
    public static ConsultarQuarto instance = null;
    private QuartoDAO             quartoDAO;
    private JTextField            txtPesquisa;
    private JLabel                blPesquisa;
    private JButton               btnPesquisar, btnCadastrar;
    ...
    public ConsultarQuarto(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        setTitle("Quarto");
        ...
        tabela.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(coluna == 7){
                    ...
                    modeloQuarto = ModeloQuarto.getInstance();
                    quartoDAO.deletarQuarto(modeloQuarto.getQuarto(linha).getNumero());
    ...
    public static ConsultarQuarto getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        if (instance == null) {
