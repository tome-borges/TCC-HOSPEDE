...
public class EditarUsuario extends InterfaceFactory {
    ...
    //Construtor..
    public EditarUsuario(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], Usuario usuarioLogado) {
    ...
    public static EditarUsuario getInstance( JButton botoes[],JMenuItem itensDeMenu[], JTextField campoDeTexto[], Usuario usuarioLogado) {
        if (instance == null) {
