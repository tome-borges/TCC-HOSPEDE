...
public class CadastrarQuarto extends InterfaceFactory {
    ...
    //Construtor.
    public CadastrarQuarto( JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
    ...
    public static CadastrarQuarto getInstance( JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        if(instance == null){
