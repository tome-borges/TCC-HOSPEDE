...
public class SelecionarQuarto extends InterfaceFactory{
    ...
    public SelecionarQuarto(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
    ...
    public static SelecionarQuarto getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        if(instance == null){
