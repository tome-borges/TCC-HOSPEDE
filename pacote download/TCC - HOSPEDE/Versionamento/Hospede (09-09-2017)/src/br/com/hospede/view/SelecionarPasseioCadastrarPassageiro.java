...
public class SelecionarPasseioCadastrarPassageiro extends InterfaceFactory{
    ...
    public SelecionarPasseioCadastrarPassageiro(JButton botoes[],JMenuItem itensDeMenu[], JTextField[] camposDeTexto, Usuario usuarioLogado){
    ...
    public static SelecionarPasseioCadastrarPassageiro getInstance(JButton botoe[],JMenuItem itensDeMenu[],  JTextField[] camposDeTexto, Usuario usuarioLogado){
        if(instance == null){
