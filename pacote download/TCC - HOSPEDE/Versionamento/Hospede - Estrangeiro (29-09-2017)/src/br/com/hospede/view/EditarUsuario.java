...
public class EditarUsuario extends InterfaceFactory {
    ...
    //Construtor..
    public EditarUsuario(JButton botoes[], JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado) {
    ...
    public static EditarUsuario getInstance( JButton botoes[],JMenuItem itensDeMenu[], JTextField campoDeTexto[], DTOUsuario usuarioLogado) {
        if (instance == null) {
            return instance = new EditarUsuario( botoes, itensDeMenu, campoDeTexto, usuarioLogado);
        }
        return instance;
    }
}
