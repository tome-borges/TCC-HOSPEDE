        ...
        tabela.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(coluna == 12){
                    ...
                    if(!modeloCliente.getCliente(linha).getCpf().equals("   .   .   -  ") && modeloCliente.getCliente(linha).getPassaport().equals("")){
                    
                    deletou = clienteDAO.deletarCliente(modeloCliente.getCliente(linha).getCpf());
                    } else {
                    deletou = clienteDAO.deletarClientePassaporte(modeloCliente.getCliente(linha).getPassaport()); 
                    }
                    if(deletou != false){
