                ...
                if(coluna == 5){
                    ...
                    historicoDAO = HistoricoDAO.getInstance();
                     ...
                     boolean deletou = false;
                      deletou = produtoDAO.deletarProduto(modelo.getProduto(linha));
            
                          try{
                              if(deletou != false){
                              DTOHistoricoProduto historicoProduto = new DTOHistoricoProduto();
                              historicoProduto.setId_produto(modelo.getProduto(linha).getId());
                              historicoProduto.setId_usuario_responsavel(usuarioLogado.getId_usuario());
                              historicoProduto.setAcao("Deletou");
                              historicoProduto.setProduto(modelo.getProduto(linha).getNome());
