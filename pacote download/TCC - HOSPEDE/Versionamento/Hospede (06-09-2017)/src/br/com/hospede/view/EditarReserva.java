...
public class EditarReserva extends InterfaceFactory{
    ...
    public EditarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
    ...
    public static EditarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        if (instance == null) {
            instance = new EditarReserva(botoes, itensDeMenu, camposDeTexto, usuarioLogado);
        }
        return instance;
    }
}
