...
public class DeletarReserva extends InterfaceFactory{
    ...
    public static DeletarReserva instance = null;
    private int id_cliente, id_quarto, id_reserva;
    private SimpleDateFormat    formatarData = new SimpleDateFormat("dd/MM/yyyy");
    
    public DeletarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        ...
        campoDeTexto[8] = txtNome;
        botoes[22] = btnExcluir;
    ...
    public void receberReserva(Reserva reserva, Cliente cliente, Quarto quarto){
    ...
    public static DeletarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        if(instance == null){
            return instance = new DeletarReserva( botoes, itensDeMenu, camposDeTexto, usuarioLogado);
        }
        return instance;
    }
}
