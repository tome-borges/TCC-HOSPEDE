...
public class EditarPasseio extends InterfaceFactory{
    ...
    public EditarPasseio(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
...
//        
    ...
    public static EditarPasseio getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado){
        if(instance == null){
