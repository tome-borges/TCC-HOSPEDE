...
public class ModeloUsuario extends AbstractTableModel{
    private static ArrayList<Usuario> dados;
    ...
    public void adicionar(Usuario usuario){
        ...
        dados = new ArrayList<Usuario>();//Depois instancia do zero um novo para adicionar apenas o usuário encontrado.
        dados.add(usuario);
        fireTableDataChanged();
    }
    
    public void adicionarLista(ArrayList<Usuario> listaUsuarios) {
