...
public class CadastrarCliente extends InterfaceFactory {
    ...
    public CadastrarCliente(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
    ...
    public static CadastrarCliente getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], Usuario usuarioLogado) {
        if (instance == null) {
