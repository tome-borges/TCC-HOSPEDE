...
public class ModeloPasseio extends AbstractTableModel{
    ...
    private String[]           colunas = {"Título","Ingresso","Data","Editar","Fechar","Cancelar"};
   ...
   public Object getValueAt(int linha, int coluna) {
       try{
        switch (coluna) {
            ...
            case 2:
                return formatarData.format(dados.get (linha).getData());
            case 3:
                return dados.get (linha).getEditar();
            case 4:
                return dados.get (linha).getDeletar();
            case 5:
                return dados.get (linha).getCancelar();
            default:
                return null;
        }
