...
public class SelecionarQuarto extends InterfaceFactory{
    ...
    public SelecionarQuarto(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        ...
        tabela.getColumnModel().getColumn(6).setMaxWidth(200);
    ...
    public static SelecionarQuarto getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            return instance = new SelecionarQuarto(botoes,itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
