...
public class SelecionarPasseioCadastrarPassageiro extends InterfaceFactory{
    ...
    public SelecionarPasseioCadastrarPassageiro(JButton botoes[],JMenuItem itensDeMenu[], JTextField[] camposDeTexto, DTOUsuario usuarioLogado, Object[] modelosTabelas){
    ...
    public static SelecionarPasseioCadastrarPassageiro getInstance(JButton botoe[],JMenuItem itensDeMenu[],  JTextField[] camposDeTexto, DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            instance = new SelecionarPasseioCadastrarPassageiro(botoe, itensDeMenu, camposDeTexto,  usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
