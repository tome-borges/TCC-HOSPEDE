...
public class AuditarReserva extends InterfaceFactory{
    ...
    private ModeloAuditarReserva modelo;
    private JTable               tabela;
    private JScrollPane          scroll;
    private JButton              btnPesquisar;
    private JDateChooser         dia;
    public static AuditarReserva instance = null;
    private ControlarEventos eventos;
    
    public AuditarReserva(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        setTitle("Auditar Reserva");
        ...
        modelo = ModeloAuditarReserva.getInstance();
    ...
    public static AuditarReserva getInstance(JButton botoes[], JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            instance = new AuditarReserva(botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
