...
public class ConsultarHospedagem extends InterfaceFactory{
    ...
    public ConsultarHospedagem(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        setTitle("Hospedagem");
        ...
        btnCadastrar.setToolTipText("Cadastrar Hospedagem.");
   ...
   public JTable getTabela(){
    ...
    public static ConsultarHospedagem getInstance(JButton botoes[],JMenuItem itensDeMenu[], JTextField camposDeTexto[], DTOUsuario usuarioLogado, Object[] modelosTabelas){
        if(instance == null){
            return instance = new ConsultarHospedagem( botoes, itensDeMenu, camposDeTexto, usuarioLogado, modelosTabelas);
        }
        return instance;
    }
}
