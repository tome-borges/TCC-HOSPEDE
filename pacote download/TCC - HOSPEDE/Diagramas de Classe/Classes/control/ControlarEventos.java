...
public class ControlarEventos implements ActionListener, FocusListener, MouseListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == botoes[0]) {//Evento acionado após clicar no botão "Entrar" da classe "Login".
            ...
            reservaDAO = ReservaDAO.getInstance();
            ModeloReservaCancelada modeloReceitaCancelada = ModeloReservaCancelada.getInstance();
            ...
            if (reservasCanceladas.getDia() == null) {
                ...
                if (receitas.size() == 0) {
                    ...
                    modeloReceitaCancelada.adicionarLista(reservaDAO.getReservasCanceladas());

                } else {
                    modeloReceitaCancelada.adicionarLista(receitas);
                }
            }
            ...
            reservaDAO = ReservaDAO.getInstance();
            modeloReservasVencidas modeloReservaVencidas = modeloReservasVencidas.getInstance();
            ...
            if (reservasVencidas.getDia() == null) {
                ...
                if (receitas.size() == 0) {
                    ...
                    modeloReservaVencidas.adicionarLista(reservaDAO.getReservasVencidas());

                } else {
                    modeloReservaVencidas.adicionarLista(receitas);
                }
            }
        ...
        } else if (evento.getSource() == itensDeMenu[2]) {//Acionado pelo item de menu "Reservas Caceladas" da classe "TelaPrincipal".
            ...
            if (interfaceReservasCanceladas == null || interfaceReservasCanceladas.isValid()) {
                ...
                ModeloReservaCancelada modeloReservasCanceladas = ModeloReservaCancelada.getInstance();
                reservaDAO = ReservaDAO.getInstance();
            ...
            if (interfaceReservasVencidas == null || interfaceReservasVencidas.isValid()) {
                ...
                modeloReservasVencidas modeloReservasVencida = modeloReservasVencidas.getInstance();
                reservaDAO = ReservaDAO.getInstance();
                
                modeloReservasVencida.adicionarLista(reservaDAO.getReservasVencidas());
